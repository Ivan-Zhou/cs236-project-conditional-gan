...
class UnalignedDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.A_paths, self.A_labels = make_dataset(self.dir_A, opt.max_dataset_size)   # load images from '/path/to/data/trainA'
        self.B_paths, self.B_labels = make_dataset(self.dir_B, opt.max_dataset_size)    # load images from '/path/to/data/trainB'
